  ...
  function z(r, n, t, xt, _t) {
    ...
    if (dt(r)) {
      ...
      var zt,
        ...
        In = "os-dragging",
        Me = "os-theme-none",
        Mn = [He, xn, An, Rn, Ln, Nn, We, De, Ee, Ie, In].join(xe),
        jn = [],
        Fn = [xi.ti],
        Pn = {},
        je = {},
      ...
      return (
        ...
        (St.scroll = function (n, t, r, e) {
          if (0 === arguments.length || n === hi) {
            ...
            return (
              ...
              (f *= o ? -1 : 1),
              {
                ...
                handleLengthRatio: { x: vn.I, y: dn.I },
                trackLength: { x: vn.M, y: dn.M },
          ...
          var c,
            ...
            W = n[xi.hOP]("el"),
            D = W ? n.el : n,
            E = !!(D instanceof Ci || ki) && D instanceof ki,
            I = !E && dt(D),
            M = function () {
              s && Qe(!0), l && Qe(!1);
            },
                  ...
                  (function s() {
                    ...
                    Kn(ir, $, function (n) {
                      f(n) &&
                        ...
                        (qr && ((r = !0), Ve()),
                        (e = c(n)),
                        (i.w = ar[xi.oW] - (Dt ? 0 : It)),
                        (i.h = ar[xi.oH] - (Dt ? 0 : Mt)),
                        (o = vt()),
                        Yn(I, [J, B, q], [tt, a, u]),
                        ci(M, In),
    ...
    function Yn(n, t, r, e, i) {
      var o = Si.isA(t) && Si.isA(r),
        ...
        f = !o && t.split(xe),
        c = 0;
      if (o) for (; c < t[xi.l]; c++) Yn(n, t[c], r[c], e);
      else
        for (; c < f[xi.l]; c++)
    ...
    function Xe(n) {
      ...
      if (
        ...
        if (
          ...
          x &&
            (si(Kt, Mr + xe + Me),
            ci(Kt, w !== hi && null !== w && 0 < w.length ? w : Me)),
          N &&
            (!0 === L || (null === L && kt)
              ? (Ve(), _t.add(St))
              : (_t.remove(St), Ue())),
          ...
          if (C)
            if ((rr ? rr.show() : ((rr = Ci(ai(Le))), Qt.before(rr)), Et))
              Gt.show();
            else {
          ...
          else Et && Gt.hide(), rr && rr.hide();
        o && (Jt.find("*").trigger(ge), Et && Gt.find("*").trigger(ge)),
        ...
        var rn = (Q || J) && C && !t,
          en = f(rn, br),
          on = !rn && br,
          an = !(!Et || !C || t) && 0 === Oi.round(P.bottom - P.top),
          un = f(an, yr),
          fn = !an && yr,
        ...
        var wn = !!Nt && Be(),
          xn = Nt && f(wn, Pr),
          _n = Nt && wn ? { w: E ? wn.q : wn.V, h: M ? wn.B : wn.$ } : {};
        if (
          ((Pr = wn),
          an && (un || T || X || Y.c || cn.c)
            ? (ln[pe] = me)
          ...
          var Nn = dn(),
            Wn = {
              w: Nn.w - Pt - jt - (Dt ? 0 : It),
              h: Nn.h - Ut - Ft - (Dt ? 0 : Mt),
            },
            Dn = {
            ...
            var En = {},
              In = function (n) {
                ...
                (i && (i || !cn.c)) || (vn[e] = Wn[r] - 1),
                  !(i && Hn[r] < f) ||
                    (n && Nt && U) ||
                    (Nt && (En[e] = ii(er.css(e)) - 1), --vn[e]),
                  0 < Hn[r] && (vn[e] = Oi.max(1, vn[e]));
              };
            In(!0), In(!1), Nt && er.css(En), rr.css(vn);
          }
          rn && (ln[he] = we),
            !rn || Dt || qr || (ln[be] = "none"),
            nr.css(ln),
            (ln = {});
          var Mn = { w: An[xi.sW], h: An[xi.sH] };
          (Mn.c = i = f(Mn, vr)),
            (vr = Mn),
            (ee = hn()),
            (e = f((Nn = dn()), lr)),
          ...
          var jn = Nt && (0 === ee.w || 0 === ee.h),
            ...
            Kn = function (n) {
              ...
              (Pn[e] = "v-s" === W[e]),
                (Un[e] = "v-h" === W[e]),
                (Vn[e] = "s" === W[e]),
                ($n[e] = Oi.max(0, Oi.round(100 * (Mn[i] - ee[i])) / 100)),
          ...
          if (
            ...
            var Gn,
              ...
              Zn = o;
            (qn.x || qn.y) &&
              ((Qn.w = zt.y && qn.y ? Mn.w + Tt.y : ye),
              (Qn.h = zt.x && qn.x ? Mn.h + Tt.x : ye),
              (Zn = f(Qn, dr)),
              (dr = Qn)),
              (qn.c || Bn.c || Mn.c || q || en || un || rn || an || R) &&
                ((ln[oe + G] = ln[ue + G] = ye),
                (Gn = function (n) {
                  var t = ni(n),
                    r = ni(!n),
          ...
          if ((nr.css(ln), Nt && i)) {
            var ot = (function wt() {
              ...
              return { G: s, J: l, Q: a, Z: c, nn: f, tn: n, rn: i };
            })();
            if (ot) {
              var at = Fr === hi || ot.Q !== Fr.Q,
                ut = ot.G,
                ft = ot.J,
                ct = ot.nn,
                st = ot.Q,
              ...
              (c.x = -1 < ht.x ? (Vt && Er && Ot.i ? 0 : ht.x) : c.x),
                (c.y = -1 < ht.y ? ht.y : c.y);
            }
            Fr = ot;
          }
          Vt && Ot.i && zt.y && qn.x && Er && (c.x += re.w || 0),
            rn && Kt[_e](0),
            an && Kt[Se](0),
            Zt[_e](c.x)[Se](c.y);
          var pt = "v" === v,
    ...
    function ft(i) {
      var n,
        t,
        o = function (n) {
          var t = pt(kn + xe + (n ? Dn : En), !0),
            r = pt(Cn, t),
            e = pt(Hn, t);
          return p || i || (t.append(r), r.append(e)), { en: t, in: r, an: e };
        };
      function r(n) {
        var t = ni(n),
          r = t.en,
    ...
    function ct(_) {
      var S,
        ...
        u = [16, 17];
      function f(n) {
        return D && t ? n["screen" + e] : Si.page(n)[k];
      }
      function c(n) {
      ...
      function L(n) {
        if (
          ...
          (T = 1),
          l(),
          S !== (z = i = hi) && (St.scrollStop(), clearTimeout(S), (S = hi)),
          n)
        ) {
          var t = ar[xi.bCR]();
          (n.clientX >= t.left &&
      ...
      Kn(r.an, $, function h(n) {
        ...
        Kn(r.en, $, function y(n) {
          Si.stpP(n);
        }),
        E &&
          Kn(r.en, Q, function (n) {
            n.target === r.en[0] && (Je(_), Qe(_));
          });
    }
    function Ke(n, t, r) {
      var e = n ? f : v;
    ...
    function Je(n) {
      var t = {},
        r = ni(n),
        e = r.un,
        i = Oi.min(1, (lr[r.F] - (Sr ? (n ? It : Mt) : 0)) / vr[r.F]);
      (t[r.X] = Oi.floor(100 * i * 1e6) / 1e6 + "%"),
        ht() || r.an.css(t),
        (e.D = r.an[0]["offset" + r.cn]),
        (e.I = i);
    }
    function Qe(n, t) {
      var r,
        ...
        v = t === hi || i ? l : t,
        d = u.D,
        h = a["in"][0]["offset" + a.cn],
        p = h - d,
        b = {},
        y = (cr[ge + a.cn] - cr["client" + a.cn]) * (Ot.n && o ? -1 : 1),
        m = function (n) {
    ...
    function lt(n, t) {
      ...
      return new RegExp("(^" + rn + "([-_].+|)$)" + o(Ir, n) + o(Mr, t), "g");
    }
    function vt() {
      var n = fr[xi.bCR]();
      return {
